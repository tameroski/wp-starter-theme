...
* In CLI, run: `git clone https://github.com/toddmotto/html5blank.git your_theme_name`
* `cd your_theme_name` and then `npm install` and then `bower install` (you'll need gulp install as well)
